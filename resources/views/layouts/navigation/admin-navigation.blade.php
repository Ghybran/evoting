<nav class="side-nav">
    ...
    <ul>
        ...
        <li>
            <a href="calon" class="side-menu">
                <div class="side-menu__icon"> <i data-feather="inbox"></i> </div>
                <div class="side-menu__title"> Inbox Calon </div>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="registercalon" class="side-menu">
                <div class="side-menu__icon"> <i data-feather="credit-card"></i> </div>
                <div class="side-menu__title"> Register calon </div>
            </a>
        </li>
        <li>
